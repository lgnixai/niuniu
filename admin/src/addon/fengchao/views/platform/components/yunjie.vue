<template>
  <el-dialog v-model="showDialog" title="亿速开放平台" width="580px" :destroy-on-close="true">
    <el-form :model="formData" label-width="140px" ref="formRef" :rules="formRules" class="page-form"
      ...
      <el-form-item label="">
        <div class="text-red">https://open.yuntongzy.com</div>
      </el-form-item>
    </el-form>
...
import { getPlatformInfo, editPlatform } from '@/addon/fengchao/api/platform'
