...
use addon\fengchao\app\service\admin\delivery\StoreService;
...
class Store extends BaseAdminController
{
    ...
    public function add()
    {
        ...
        $this->validate($data, 'addon\fengchao\app\validate\delivery\Store.add');
    ...
    public function edit($id)
    {
        ...
        $this->validate($data, 'addon\fengchao\app\validate\delivery\Store.edit');
