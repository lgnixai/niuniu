...
use addon\fengchao\app\service\admin\delivery\ElectronicSheetService;
...
class ElectronicSheet extends BaseAdminController
{
    ...
    public function add()
    {
        ...
        $this->validate($data, 'addon\fengchao\app\validate\delivery\ElectronicSheet.add');
    ...
    public function edit(int $id)
    {
        ...
        $this->validate($data, 'addon\fengchao\app\validate\delivery\ElectronicSheet.edit');
