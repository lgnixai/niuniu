<template>
    <div class="main-container">
        ...
        <el-card shadow="never" class="mt-[15px] !border-none">
            ...
            <el-row>
                <el-col :span="4" class="cursor-pointer" @click="router.push({ path: '/fengchao/order/index', query: {status: 1}})">
                    <div class="ml-[10px]">
                ...
                <el-col :span="4" class="cursor-pointer" @click="router.push({ path: '/fengchao/order/index', query: {status: 2}})">
                ...
                <el-col :span="4" class="cursor-pointer" @click="router.push({ path: '/fengchao/order/index', query: {status: 3}})">
                ...
                <el-col :span="4" class="cursor-pointer" @click="router.push({ path: '/fengchao/order/refund'})">
                ...
                <el-col :span="4" class="cursor-pointer" @click="router.push({ path: '/fengchao/goods/list'})">
                ...
                <el-col :span="4" class="cursor-pointer" @click="router.push({ path: '/fengchao/goods/list', query: {status: 0}})">
...
import { t } from '@/lang'
import {
    getfengchaoCountList,
    getfengchaoTodayCountList,
    getfengchaoYesterdayCountList,
    getfengchaoStat,
    getfengchaoOrderStat,
    getfengchaoGoodsStat
} from '@/addon/fengchao/api/fengchao'
...
const getStatInfoFn = async () => {
    let statTotalData = await (await getfengchaoCountList()).data
    for( let i in statTotalData){
        statTotalData[i] = Number(statTotalData[i])

    }
    statTotal.value = statTotalData
    statToday.value = await (await getfengchaoTodayCountList()).data
    statYesterday.value = await (await getfengchaoYesterdayCountList()).data
    statOrder.value = await (await getfengchaoOrderStat()).data
    statGoods.value = await (await getfengchaoGoodsStat()).data
    statCount.value = await (await getfengchaoStat()).data
    setTimeout(() => {
        drawChart('')
        drawChartTo('')
    }, 20)
